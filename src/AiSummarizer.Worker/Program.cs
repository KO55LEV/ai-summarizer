...
builder.Services.AddSingleton<IJobHandler, ResearchTopicPlanJobHandler>();
...
builder.Services.AddScoped<IResearchSearchPlanningService, ResearchSearchPlanningService>();

...
public interface ITodosRepository
{
    ...
    Task<IReadOnlyList<TodoItemDto>> ListTodosAsync(Guid? requestedByUserId, Guid? projectId, string? bucket, string? cadence, string? status, int limit, int offset, CancellationToken cancellationToken);
    Task<TodoStatsDto> GetStatsAsync(Guid? requestedByUserId, Guid? projectId, string? bucket, string? cadence, string? status, CancellationToken cancellationToken);
...
{
    Task<TodoListDto> ListTodosAsync(Guid? requestedByUserId, Guid? projectId, string? bucket, string? cadence, string? status, int limit, int offset, CancellationToken cancellationToken);
